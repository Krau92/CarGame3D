...
namespace ArcadeVP
{
    ...
    public class AVC_Editor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Toggle canMove button
            ArcadeVehicleController controller = (ArcadeVehicleController)target;
            System.Reflection.FieldInfo canMoveField = typeof(ArcadeVehicleController)
                .GetField("canMove", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            bool currentCanMove = (bool)canMoveField.GetValue(controller);

            GUI.backgroundColor = currentCanMove ? Color.green : Color.red;
            if (GUILayout.Button(currentCanMove ? "canMove: ON" : "canMove: OFF", GUILayout.Height(30f)))
            {
                controller.SetCanMove(!currentCanMove);
            }
